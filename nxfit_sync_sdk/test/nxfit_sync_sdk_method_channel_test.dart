...
void main() {
  ...
  group('NxfitSyncSdkImpl Tests', () {
    ...
    test('isConnected should return false when platform returns null', () async {
      // Setup - return null
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (MethodCall methodCall) async {
        if (methodCall.method == 'isConnected') {
    ...
    test('sync should invoke platform method', () async {
      // Setup
      bool syncCalled = false;
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
          .setMockMethodCallHandler(channel, (MethodCall methodCall) async {
        if (methodCall.method == 'sync') {
          syncCalled = true;
        }
        return null;
      });
    ...
    test('configure should be called with correct parameters during init', () async {
      // Setup
      ...
      TestDefaultBinaryMessengerBinding.instance.defaultBinaryMessenger
        ...
        if (methodCall.method == 'configure') {
          ...
          configureArgs = Map<String, dynamic>.from(methodCall.arguments as Map);
        }
        return null;
      });
