## 0.0.11
- For Android, updated the nxfit-sdk-healthconnect version to 9.5.0. This adds a number of Health Connect record types to the sync and fixes a number of issues.
- For iOS, updated the nxfit-sdk-for-ios version to 2.0.0. This adds a number of Health Connect record types to the sync and fixes a number of issues.
